...
We can re-center period by period, making the synthetic control the x-axis, to show a kind of event study plot
```{r, fig.width=7.5, fig.height=4}
  plot(estimate, spaghetti.units=rownames(top.controls), center.on.control=TRUE)
```
